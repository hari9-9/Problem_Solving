...
public class TopologicalSortWithPath {
...
//   public static Integer[] dagLongestPath(Map<Integer, List<Edge>> graph, int start, int numNodes) {
//     Map<Integer, List<Edge>> graphNegate = new HashMap<>();
//     graphNegate = graph;

//     for(Map.Entry<Integer,List<Edge>> entry: graphNegate.entrySet()){
...
public static Integer[] dagLongestPath(Map<Integer, List<Edge>> graph, int start, int numNodes) {
      ...
      if (dist[nodeIndex] != null) {
        ...
        if (adjacentEdges != null) {
          for (Edge edge : adjacentEdges) {
            ...
            int newDist = dist[nodeIndex] + (-1*edge.weight);
  ...
  public static void main(String[] args) {
    ...
    Integer [] longest = dagLongestPath(graph, 0, N);
    System.out.println("Longest between 0 to 4 " + -1*longest[4]);
  }
}